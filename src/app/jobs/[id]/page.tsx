...
export default async function JobDetailPage({
    ...
    // ✅ Safely fetch job
    const { data: job, error } = await getJobById(parseInt(id, 10));
        ...
        return (
            <div className="container mx-auto py-10">
                <Alert variant="destructive">
                    ...
                    <AlertDescription>
                        {error ||
                            'Could not load the job posting. It may have been deleted or the link is incorrect.'}
                    </AlertDescription>
                    <div className="mt-4">
                        <Button asChild>
                ...
                <Card className="shadow-lg border-primary/20">
                    <CardHeader>
                        <div className="flex items-center gap-4 mb-4">
                            {job.companyLogo && (
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_API_BASE_URL}${job.companyLogo}`}
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-x-6 gap-y-2 text-muted-foreground mt-4 text-sm">
                                    ...
                                    <span className="flex items-center gap-2">
                                        ...
                                        Posted on {format(new Date(job.datePosted), 'PPP')}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    {job.is_active ? (
                        ...
                        <CardFooter className="p-0">
                            <Alert
                                variant="destructive"
                                className="w-full rounded-t-none rounded-b-lg border-x-0 border-b-0"
                            >
